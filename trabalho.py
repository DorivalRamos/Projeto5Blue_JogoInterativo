...
class Trabalho:
    ...
    # Criação da SETTER para remover dinheiro após eventos aleatórios ou compras de supermercado
    @statusDinheiro.setter
    def statusDinheiroRE(self, dinheiro):
        self.statusDinheiro -= dinheiro

    def homeOffice(self):
        # Adiciona dinheiro após um dia de trabalho
        Trabalho.statusDinheiroAD(dinheiro=10)
        # Remove estamina após um dia de trabalho
